...
public class MyStackWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.firyal.moviecatalogue.TOAST_ACTION";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.banner_movie);
